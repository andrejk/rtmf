...
logger = Logger.getLogger("rtmfguc.script.TerugmeldingToZaakMetStapEnStatus")
...
def formulier = null
def stapOmschrijvingCreate = "Het ontvangen van de terugmelding door de bronhouder"
...
def binding = ["oehId": codeBronhouder,
               ...
               "Begindatum": datumTijdNaarZakenmagazijnFormaat(tInfo.startDatum),
               ...
               "Datumstatusgezet": datumTijdNaarZakenmagazijnFormaat(tInfo.startDatum), 
...
String templateToLoad = "templates/ZaakMetStapEnStatus.template"
