...
public class TestZaakUpdate extends FunctionalTestCase {

	String terugmeldingGMRequest = "<S:Envelope xmlns:S=\"http://schemas.xmlsoap.org/soap/envelope/\">"
			+ "	<S:Header>"
			...
			+ "			</ns2:attributen>"
			+ "			<ns2:contactInfo>"
			+ "				<ns2:naam>De unit tester</ns2:naam>"
			+ "				<ns2:telefoon></ns2:telefoon>"
			+ "				<ns2:email>de.unit.tester@het.test.systeem.rotterdam.nl</ns2:email>"
			+ "			</ns2:contactInfo>"
			+ "			<ns2:attachment>"
	...
	String ZAAK_NUMMER = "TMD.09.10.10101";
	...
	public void testUpdateZaakTerugmelding() throws Exception {
		...
		MuleMessage message = new DefaultMuleMessage(new String[] {
		...
		assertNotNull(
				...
				response);
		assertNotNull(
				"Geen payload gevonden in de response van UpdateZaak (terugmelding)",
				response.getPayload());
	...
	public void testUpdateZaakIntrekking() throws Exception {
		...
		MuleMessage response = client.send(
				"vm://rtmfguc/zakenMagazijnIntrekkingUpdateZaak", message);
		assertNotNull(
				"Geen response teruggekregen na aanroep UpdateZaak (intrekking).",
				response);
		assertNotNull(
				"Geen payload gevonden in de response van UpdateZaak (intrekking)",
				response.getPayload());
